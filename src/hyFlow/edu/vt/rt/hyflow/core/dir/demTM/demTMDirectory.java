 ...
 * @param context 
   ...
   **/
  public void releaseResponse (AbstractContext  context, GlobalObject key, Object object, PE from, boolean deny) {
    getServerSide(key).releaseResponse(context, object, from, deny);
  }

  private static synchronized ClientSide getClientSide (GlobalObject key) {
    try {
      //Logger.debug("Call a client side");
