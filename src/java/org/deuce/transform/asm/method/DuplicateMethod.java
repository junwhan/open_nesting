...
import org.deuce.transform.asm.code.ControlFlowCode;
...
public class DuplicateMethod extends MethodAdapter{
	...
	public DuplicateMethod(MethodVisitor mv, boolean isstatic, Method newMethod, FieldsHolder fieldsHolder, String cln) {
		super(mv);
	...
	public void visitCode(){
		//Add Code to support control flow 
		if(isRemote)
			ControlFlowCode.addCode(super.mv, className, method, argumentsSize, isStatic);
		super.visitCode();
	}
	...
	public void visitMethodInsn(int opcode, String owner, String name,
			String desc) 
	{
		if( ExcludeIncludeStore.exclude(owner) || name.equals("<init>"))	//To remove any constructor call
		{
