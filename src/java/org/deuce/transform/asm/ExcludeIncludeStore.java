...
public class ExcludeIncludeStore {
	...
	static{
		...
		excludeIncludeStore.excludeClass.add("edu/vt/rt/hyflow/benchmark/tm/Benchmark");		
	}
	...
	public static boolean exclude(String className){
		if(excludeIncludeStore.excludeClass.contains(className))
			return true;
		if(!className.startsWith("edu/vt/rt/hyflow/benchmark/tm"))
			return true;
		if(className.contains("Benchmark"))
			return true;
//		if(className.equals("edu/vt/rt/hyflow/benchmark/tm/bankLoader/BankAccount"))
//			return true;
